...
import io.swagger2.api.config.StringToEnumConverter;
...
public enum EventId {
	LOAD_LEVEL_INFORMATION, NETWORK_PERFORMANCE, NF_LOAD, SERVICE_EXPERIENCE, UE_MOBILITY, UE_COMMUNICATION, QOS_SUSTAINABILITY, ABNORMAL_BEHAVIOUR, USER_DATA_CONGESTION, NSI_LOAD_LEVEL;
...
*/
 /* @Override
  public String toString() {
	  StringToEnumConverter sb = new StringToEnumConverter();
