...
public class CivicAddress   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(country, a1, a2, a3, a4, a5, a6, PRD, POD, STS, HNO, HNS, LMK, LOC, NAM, PC, BLD, UNIT, FLR, ROOM, PLC, PCN, POBOX, ADDCODE, SEAT, RD, RDSEC, RDBR, RDSUBBR, PRM, POM);
  }
